...
const NavMobile: React.FC<NavMobileProps> = ({
  ...
  return (
      <div id="nav-mobile" className="overflow-y-auto w-full h-screen py-2 transition transform shadow-lg ring-1 dark:ring-neutral-700 bg-white dark:bg-neutral-900 divide-y-2 divide-neutral-100 dark:divide-neutral-800">
