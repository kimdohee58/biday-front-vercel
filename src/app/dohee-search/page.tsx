...
//                         const subNameMatches = product.subName && product.subName.includes(keyword); // 한글 포함 여부
...
//     const selectedProducts = filteredProducts.length > 0 ? tempProducts.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage) : tempProducts;
//
...
//         setCurrentPage(1);
//         console.log('필터링된 제품:', newFilteredProducts); // 로그 찍기
//     };
//
//     return (
...
//                                 {products.length > 0 ? (
//                                     products.slice(0, 20).map((item) => ( // 최대 20개만 표시
//                                         <ProductCard data={item} image={getProductImage(item)} key={item.id}/>
//                                     ))
//                                 ) : (
